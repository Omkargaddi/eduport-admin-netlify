...
export default function UserMetaCard() {
  ...
  const handleSave = async () => {
    try {
      ...
      const profileData = {
        username: `${editablefName} ${editablelName}`,
        address: address,
        instagram: instagram,
        facebook: facebook,
        twitter: twitter,
              ...
              <img
                src={
                  userData.profileImageUrl
                    ? userData.profileImageUrl
                    : "https://eduport-wda-project.s3.eu-north-1.amazonaws.com/defaultUser.webp"
                }
                alt="user"
              />
            </div>
          ...
          <form className="flex flex-col">
            <div className="custom-scrollbar h-[450px] overflow-y-auto px-2 pb-3">
              <div>
                ...
                <div className="profile-image-section flex flex-col items-center space-y-2">
                  <div
                    className="profile-image-wrapper w-28 h-28 rounded-full border-2 border-gray-300 dark:border-gray-600 overflow-hidden bg-gray-100 dark:bg-gray-700 flex items-center justify-center cursor-pointer mb-3"
                  ...
                  >
                    {profileImage ? (
                      <img
                        src={profileImage}
                        alt="Profile"
                        className="profile-image-preview w-full h-full object-cover "
                      />
                    ) : (
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  <div className="col-span-2 lg:col-span-1">
                    ...
                    <Input
                      type="text"
                      value={editablefName}
                      onChange={(e) => setEditablefName(e.target.value)}
                    />
                  </div>
                  ...
                  <div className="col-span-2 lg:col-span-1">
                    ...
                    <Input
                      type="text"
                      value={editablelName}
                      onChange={(e) => setEditablelName(e.target.value)}
                    />
                  </div>
